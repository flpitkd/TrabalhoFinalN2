...
public class ConsultasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdicionar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ConsultasActivity.this, CadastroActivity.class);
        ...
        lvLivros.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    Consulta consultaSelecionado = lista.get(i);

                Intent intent = new Intent(ConsultasActivity.this, CadastroActivity.class);
                intent.putExtra("acao", "editar");
                intent.putExtra("idLivro", consultaSelecionado.getId());
                intent.putExtra("titulo", consultaSelecionado.getTitulo());
                intent.putExtra("autor", consultaSelecionado.getAutor());
                intent.putExtra("genero", consultaSelecionado.getGenero().getId());
                startActivity( intent );
            }
        });
    ...
    protected void onStart() {
       ...
       //         l.setGenero(snapshot.child("genero").getValue(Genero.class) );
                Consulta l = snapshot.getValue(Consulta.class);
                lista.add( l );
